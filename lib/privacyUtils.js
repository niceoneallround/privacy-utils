...
//        'http://privacy.pn.schema.webshield.io/otype#pipe_generated_uuid   // uuid identifies context needed by pn to de-crypt
//        ]
...
// props.otype - the otype used to de-crypt see abobve - required
...
function createValue(props) {
  ...
  assert(props.otype, util.format('privacyUtils.createValue no props.otype provided:%j', props));
  assert(!Array.isArray(props.otype), util.format('privacyUtils.createValue props.otype cannot be an array:%j', props));
